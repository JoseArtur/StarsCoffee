...
class PayChannelAdapter(
    val context: Context,
    val selectedChannel: PaymentChannels,
    val list: List<PaymentChannels>,
    val listener: ClickListener<PaymentChannels>
    ...
    inner class PayChannelViewHolder(val binding: ListPaychannelBinding) :
