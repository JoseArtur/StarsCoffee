...
class PaymentOptionDialog(
    private val pList: List<PaymentChannels>,
    private var selectedChannel: PaymentChannels,
    private val listener: ClickListener<PaymentChannels>
) : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.recyclerPayChannel.layoutManager =
